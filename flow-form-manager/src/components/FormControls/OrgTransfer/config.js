...
const defaultOption = {
  ...
  onload: loadDepData,
  // 搜索节点方法 
  onsearch: async function (  resolve ) {
...
export const USER_CONFIG = Object.assign( {}, defaultOption, { tabKey: 'user', tabName: '指定人员', onload: loadUserData, disabled: ( data ) => !data.hasOwnProperty( 'userId' ) } )
